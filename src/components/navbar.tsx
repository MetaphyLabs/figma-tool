      ...
      <aside className='inset-y fixed  left-0 z-20 flex h-full flex-col border-r'>
        <div className=' p-2'>
          <Button variant='outline' size='icon' aria-label='Home'>
             ...
             */}
            <Image src='/logo1.jpeg' alt='logo' width={75} height={75} />
          </Button>
        </div>
        <nav className='grid gap-1 p-2'>
          <Tooltip>
            <TooltipTrigger asChild>
              <Button onClick={() => router.push('/app')} variant='ghost' size='icon' className='rounded-lg bg-muted' aria-label='Playground'>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button onClick={() => router.push('/app/history')} variant='ghost' size='icon' className='rounded-lg' aria-label='Models'>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button onClick={() => router.push('/app/integrations')} variant='ghost' size='icon' className='rounded-lg' aria-label='Documentation'>
